...
/// SplitMix64 — fixed constants → identical output on every platform, and it
/// mixes well enough that consecutive draws (and derived sub-seeds) are
/// independent. No heap, no globals.
struct Rng64 {
    u64 state;
